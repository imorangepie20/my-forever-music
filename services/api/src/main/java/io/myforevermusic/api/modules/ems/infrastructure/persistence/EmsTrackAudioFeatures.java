...
@Embeddable
public class EmsTrackAudioFeatures {
    ...
    protected EmsTrackAudioFeatures() {
    }

    public EmsTrackAudioFeatures(
    ...
    public String getAudioFeatureTrackId() { return audioFeatureTrackId; }
    public String getAudioFeatureSource() { return audioFeatureSource; }
    public boolean isAudioFeaturesFilled() { return audioFeaturesFilled; }
    public String getAnalysisUrl() { return analysisUrl; }
    public String getTrackHref() { return trackHref; }
    public String getAudioTrackUri() { return audioTrackUri; }
